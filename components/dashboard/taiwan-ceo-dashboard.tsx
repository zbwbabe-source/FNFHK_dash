            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border-l-4 border-blue-600">
              ...
              <div className="space-y-2 text-sm text-gray-700">
                {(() => {
                  ...
                  if (salesSummary?.total_yoy && salesSummary.total_yoy >= 100) {
                    insights.push(
                      <div key="total_sales" className="flex items-start">
                        ...
                        <span>
                          <span className="font-semibold">전체 매출 성장:</span> {formatNumber(salesSummary?.total_net_sales || 0)}K 
                          (<span className="bg-green-100 px-1 rounded font-bold">YOY {formatPercent(salesSummary?.total_yoy)}%</span>, 
                          전년비 <span className="bg-green-100 px-1 rounded font-bold">+{formatNumber(salesSummary?.total_change || 0)}K</span>)
                        </span>
                      </div>
                    );
                  }
                  ...
                  // 4. 온라인 성장
                  const onlineYoy = twOnline?.yoy || 0;
                  const onlineSales = (twOnline?.current?.net_sales || 0) / 1000;
                  // 온라인 매출을 1K 단위로 변환 후 전체 매출(이미 1K 단위)로 나눔
                  const onlineShare = (onlineSales / (salesSummary?.total_net_sales || 1)) * 100;
                  ...
                  // 6. 직접이익률 개선
                  const directProfitRate = (pl as any)?.direct_profit_rate || 0;
                  // 전년 직접이익률 계산 (direct_profit_rate가 없으면 직접 계산)
            ...
            <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-lg p-4 border-l-4 border-orange-600">
              ...
              <div className="space-y-2 text-sm text-gray-700">
                {(() => {
                  ...
                  const prevOperatingProfit = plData?.current_month?.prev_month?.total?.operating_profit || 0;
                  const isProfit = operatingProfit >= 0;
                  const isImproving = isProfit && operatingProfitChange >= 0;
                  const isDeteriorating = !isProfit && operatingProfitChange < 0;
                  ...
                  // 3. 오프라인 성장 둔화
                  const retailYoy = twRetail?.yoy || 0;
                  const outletYoy = twOutlet?.yoy || 0;
                  const avgOfflineYoy = (retailYoy + outletYoy) / 2;
                  const offlineDirectProfit = plData?.channel_direct_profit?.tw_offline?.direct_profit || 0;
                  const offlineDirectProfitYoy = plData?.channel_direct_profit?.tw_offline?.yoy || 0;
                  ...
                  const salaryChange = (expenseDetail?.salary || 0) - ((plData?.current_month?.prev_month?.total?.expense_detail as any)?.salary || 0);
                  const marketingChange = (expenseDetail?.marketing || 0) - ((plData?.current_month?.prev_month?.total?.expense_detail as any)?.marketing || 0);
            ...
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-4 border-l-4 border-purple-600">
              ...
              <div className="space-y-2 text-sm text-gray-700">
                {(() => {
                  ...
                  // 1. 수익성 회복
                  const currentOpRate = (pl as any)?.operating_profit_rate || 0;
                  ...
                  // 4. 온라인 확대
                  const onlineYoyForStrategy = twOnline?.yoy || 0;
                  if (onlineYoyForStrategy >= 100) {
                    strategies.push(
                ...
                <div className="mt-3 pt-3 border-t space-y-1">
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="font-semibold text-purple-600">
                      ...
                      <span className="text-gray-500"> (전년비 {formatPercent(((plData?.current_month?.total as any)?.discount_rate || 0) - ((plData?.current_month?.prev_month?.total as any)?.discount_rate || 0), 1)}%p)</span>
                    </span>
                  </div>
                  <div className="flex justify-between text-xs pl-3">
                    <span className="text-gray-600">- Retail</span>
              ...
              <tbody>
                ...
                <tr className="border-b border-gray-200">
                  ...
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.offline?.tag_sales || 0) - (plData?.current_month?.prev_month?.offline?.tag_sales || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>{change >= 0 ? '+' : ''}{formatNumber(change)}</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.online?.tag_sales || 0) - (plData?.current_month?.prev_month?.online?.tag_sales || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>{change >= 0 ? '+' : ''}{formatNumber(change)}</span>;
                    })()}
                  </td>
                ...
                <tr className="border-b border-gray-200">
                  ...
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.offline?.net_sales || 0) - (plData?.current_month?.prev_month?.offline?.net_sales || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>{change >= 0 ? '+' : ''}{formatNumber(change)}</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.online?.net_sales || 0) - (plData?.current_month?.prev_month?.online?.net_sales || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>{change >= 0 ? '+' : ''}{formatNumber(change)}</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300 font-semibold">
                ...
                <tr className="border-b border-gray-200">
                  ...
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.offline?.discount_rate || 0) - (plData?.current_month?.prev_month?.offline?.discount_rate || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-red-600' : 'text-blue-600'}`}>{change >= 0 ? '+' : ''}{formatPercent(change, 1)}%p</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = ((plData?.current_month?.online as any)?.discount_rate || 0) - ((plData?.current_month?.prev_month?.online as any)?.discount_rate || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-red-600' : 'text-blue-600'}`}>{change >= 0 ? '+' : ''}{formatPercent(change, 1)}%p</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300 font-semibold">
                ...
                <tr className="border-b border-gray-200">
                  ...
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.offline?.gross_profit || 0) - (plData?.current_month?.prev_month?.offline?.gross_profit || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>{change >= 0 ? '+' : ''}{formatNumber(change)}</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.online?.gross_profit || 0) - (plData?.current_month?.prev_month?.online?.gross_profit || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>{change >= 0 ? '+' : ''}{formatNumber(change)}</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300 font-semibold">
                ...
                <tr className="border-b border-gray-200">
                  ...
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.offline?.gross_profit_rate || 0) - (plData?.current_month?.prev_month?.offline?.gross_profit_rate || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>{change >= 0 ? '+' : ''}{formatPercent(change, 1)}%p</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.online?.gross_profit_rate || 0) - (plData?.current_month?.prev_month?.online?.gross_profit_rate || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>{change >= 0 ? '+' : ''}{formatPercent(change, 1)}%p</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300 font-semibold">
                ...
                <tr className="border-b border-gray-200">
                  ...
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.offline?.direct_cost || 0) - (plData?.current_month?.prev_month?.offline?.direct_cost || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-red-600' : 'text-green-600'}`}>{change >= 0 ? '+' : ''}{formatNumber(change)}</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.online?.direct_cost || 0) - (plData?.current_month?.prev_month?.online?.direct_cost || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-red-600' : 'text-green-600'}`}>{change >= 0 ? '+' : ''}{formatNumber(change)}</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300 font-semibold">
                ...
                <tr className="border-b border-gray-200">
                  ...
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.offline?.direct_profit || 0) - (plData?.current_month?.prev_month?.offline?.direct_profit || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>{change >= 0 ? '+' : ''}{formatNumber(change)}</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.online?.direct_profit || 0) - (plData?.current_month?.prev_month?.online?.direct_profit || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>{change >= 0 ? '+' : ''}{formatNumber(change)}</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300 font-semibold">
                ...
                <tr className="border-b border-gray-200">
                  ...
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.offline?.direct_profit_rate || 0) - (plData?.current_month?.prev_month?.offline?.direct_profit_rate || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>{change >= 0 ? '+' : ''}{formatPercent(change, 1)}%p</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.online?.direct_profit_rate || 0) - (plData?.current_month?.prev_month?.online?.direct_profit_rate || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>{change >= 0 ? '+' : ''}{formatPercent(change, 1)}%p</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300 font-semibold">
                ...
                <tr className="border-b border-gray-200">
                  ...
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.offline?.sg_a || 0) - (plData?.current_month?.prev_month?.offline?.sg_a || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-red-600' : 'text-green-600'}`}>{change >= 0 ? '+' : ''}{formatNumber(change)}</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.online?.sg_a || 0) - (plData?.current_month?.prev_month?.online?.sg_a || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-red-600' : 'text-green-600'}`}>{change >= 0 ? '+' : ''}{formatNumber(change)}</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300 font-semibold">
                ...
                <tr className="border-b border-gray-200">
                  ...
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.offline?.operating_profit || 0) - (plData?.current_month?.prev_month?.offline?.operating_profit || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>{change >= 0 ? '+' : ''}{formatNumber(change)}</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.online?.operating_profit || 0) - (plData?.current_month?.prev_month?.online?.operating_profit || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>{change >= 0 ? '+' : ''}{formatNumber(change)}</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300 font-semibold">
                ...
                <tr className="border-b border-gray-200">
                  ...
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.offline?.operating_profit_rate || 0) - (plData?.current_month?.prev_month?.offline?.operating_profit_rate || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>{change >= 0 ? '+' : ''}{formatPercent(change, 1)}%p</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300">
                    {(() => {
                      const change = (plData?.current_month?.online?.operating_profit_rate || 0) - (plData?.current_month?.prev_month?.online?.operating_profit_rate || 0);
                      return <span className={`font-bold ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>{change >= 0 ? '+' : ''}{formatPercent(change, 1)}%p</span>;
                    })()}
                  </td>
                  <td className="p-2 text-right border-r border-gray-300 font-semibold">
              ...
              <div className="mt-4">
                <table className="w-full text-[10px] border-collapse border border-gray-300">
                  ...
                  <tbody>
                    {selectedItem === '전체' ? (
                      <>
                        {['당시즌F', '당시즌S', '과시즌F', '과시즌S', '모자', '신발', '가방외'].map((item) => (
                          <tr key={item}>
                  ...
                  <div className="space-y-0.5 text-xs text-blue-700">
                    {(() => {
                      ...
                      const totals = monthlyData.map((item: any) => {
                        ...
                        const 가방외 = Math.round((item.가방외?.net_sales || 0) / 1000);
                        return 당시즌F + 당시즌S + 과시즌F + 과시즌S + 모자 + 신발 + 가방외;
                      });
                      const maxTotal = Math.max(...totals);
                      const minTotal = Math.min(...totals);
                      const maxMonth = monthlyData[totals.indexOf(maxTotal)]?.period?.slice(2, 4) || '';
          ...
          <div className="mt-4">
            <div className="flex flex-wrap gap-2 justify-center">
              {[
                ...
                { name: '가방외', color: '#C4B5FD', displayName: '가방외', emoji: '👜' },
              ].map((item) => (
                <button
                  key={item.name}
                  onClick={() => {
                      ...
                      <ResponsiveContainer width="100%" height={200}>
                        <LineChart data={months.map((month, idx) => ({
                          ...
                          <Line 
                            ...
                            dot={(props: any) => {
                              const { payload, cx, cy, index } = props;
                              const yoyValue = payload?.bagEtc;
                              const dotColor = yoyValue !== null && yoyValue !== undefined 
                                ? (yoyValue >= 100 ? '#EF4444' : '#10B981') 
                                : '#9CA3AF';
                              return (
                                <circle key={`bagEtc-${index}-${cx}-${cy}`} cx={cx} cy={cy} r={4} fill={dotColor} stroke="#fff" strokeWidth={1} />
                              );
                            }}
                            connectNulls 
                            name="👜 가방외" 
        ...
        <div className="bg-white rounded-lg shadow-md p-4">
          ...
          <div className="grid grid-cols-4 gap-4 w-full">
            ...
            {(() => {
              ...
              // 대형 흑자매장들의 합계 인건비율, 임차료율, 감가상각비율 계산
              let totalLaborCost = 0;
              let totalRent = 0;
              let totalDepreciation = 0;
              let totalNetSales = 0;
              
              cat.stores.forEach((store: any) => {
              ...
              return (
                <div className="bg-green-50 rounded-lg p-4 border-2 border-green-500 min-w-0">
                  <h4 className="text-sm font-bold text-green-800 mb-2">대형 흑자매장</h4>
                  <div className="text-xs text-green-700 mb-2 font-semibold">직접이익 100K+</div>
                  <div className="space-y-2 text-xs mb-3">
                      ...
                      const netSales = (store.current?.net_sales || 0) / 1000;
                        ...
                        <div key={idx} className="flex justify-between items-center bg-white rounded px-2 py-1.5">
                          <span className="font-semibold text-green-900 text-xs">{store.shop_nm}</span>
                  ...
                  <div className="border-t border-green-300 pt-2 mt-3">
                    ...
                    <div className="mt-2 pt-2 border-t border-green-200">
                      <div className="text-[10px] text-green-700 font-semibold mb-1">합계 비율 (실판매출 대비)</div>
                      <div className="grid grid-cols-3 gap-2 text-[10px] text-green-600">
                        <div>
            ...
            {(() => {
              ...
              // 중소형 흑자매장들의 합계 인건비율, 임차료율, 감가상각비율 계산
              let totalLaborCost = 0;
              let totalRent = 0;
              let totalDepreciation = 0;
              let totalNetSales = 0;
              ...
              return (
                <div className="bg-blue-50 rounded-lg p-4 border-2 border-blue-500 min-w-0">
                  <h4 className="text-sm font-bold text-blue-800 mb-2">중소형 흑자매장</h4>
                  <div className="text-xs text-blue-700 mb-2 font-semibold">직접이익 100K 미만</div>
                  <div className="space-y-2 text-xs mb-3">
                    {cat.stores.map((store: any, idx: number) => {
                      const netSales = (store.current?.net_sales || 0) / 1000;
                  ...
                  <div className="border-t border-blue-300 pt-2 mt-3">
                    ...
                    <div className="mt-2 pt-2 border-t border-blue-200">
                      <div className="text-[10px] text-blue-700 font-semibold mb-1">합계 비율 (실판매출 대비)</div>
                      <div className="grid grid-cols-3 gap-2 text-[10px] text-blue-600">
                        <div>
                          <div className="font-semibold">인건비율</div>
                          <div>{formatPercent(laborCostRatio, 1)}%</div>
                        </div>
            ...
            {expenseType === '당월' ? (
              <>
                {(() => {
                  ...
                  const current = currentMonthData?.expense_detail?.salary || 0;
                  const prev = prevMonthData?.expense_detail?.salary || 0;
            ...
            {expenseType === '당월' ? (
              <>
                {(() => {
                  const currentMonthData = plData?.current_month?.total;
                  const prevMonthData = plData?.current_month?.prev_month?.total;
                  const current = currentMonthData?.expense_detail?.other_detail?.logistics || 0;
                  const prev = prevMonthData?.expense_detail?.other_detail?.logistics || 0;
                  const change = current - prev;
                  const changeRate = prev !== 0 ? (current / prev) * 100 : 0;
                  const currentSales = currentMonthData?.net_sales || 0;
                  const prevSales = prevMonthData?.net_sales || 0;
              ...
              <>
                {(() => {
                  const cumulativeData = plData?.cumulative?.total;
                  const prevCumulativeData = plData?.cumulative?.prev_cumulative?.total;
                  const current = cumulativeData?.expense_detail?.other_detail?.logistics || 0;
                  const prev = prevCumulativeData?.expense_detail?.other_detail?.logistics || 0;
                  const change = current - prev;
                  const changeRate = prev !== 0 ? (current / prev) * 100 : 0;
                  const currentSales = cumulativeData?.net_sales || 0;
                  const prevSales = prevCumulativeData?.net_sales || 0;
            ...
            {expenseType === '당월' ? (
              <>
                {(() => {
                  ...
                  const rent = directCostItems.rent.current;
                  const logistics = currentMonthData?.expense_detail?.other_detail?.logistics || 0;
                  const current = totalDirectCost - rent - logistics;
                  
                  const prevTotalDirectCost = prevMonthData?.direct_cost || 0;
                  const prevRent = directCostItems.rent.previous;
                  const prevLogistics = prevMonthData?.expense_detail?.other_detail?.logistics || 0;
                  const prev = prevTotalDirectCost - prevRent - prevLogistics;
                  ...
                  // 기타 직접비 상세 항목
                  const otherDetail = currentMonthData?.expense_detail?.other_detail || {};
                  const maintenance = otherDetail.maintenance || 0;
                  const depreciation = otherDetail.depreciation || 0;
                  const fee = currentMonthData?.expense_detail?.fee || 0;
              ...
              <>
                {(() => {
                  ...
                  const rent = directCostItems.rent.current; // 누적은 당월과 동일하게 처리 (실제로는 별도 계산 필요)
                  const logistics = cumulativeData?.expense_detail?.other_detail?.logistics || 0;
                  const current = totalDirectCost - rent - logistics;
                  
                  const prevTotalDirectCost = prevCumulativeData?.direct_cost || 0;
                  const prevRent = directCostItems.rent.previous;
                  const prevLogistics = prevCumulativeData?.expense_detail?.other_detail?.logistics || 0;
                  const prev = prevTotalDirectCost - prevRent - prevLogistics;
                  ...
                  // 기타 직접비 상세 항목
                  const otherDetail = cumulativeData?.expense_detail?.other_detail || {};
                  const maintenance = otherDetail.maintenance || 0;
                  const depreciation = otherDetail.depreciation || 0;
                  const fee = cumulativeData?.expense_detail?.fee || 0;
